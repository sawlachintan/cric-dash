...
layout = html.Div(children=[html.Div(children=[
    ...
    dcc.RangeSlider(2008, 2022, 1, value=[2016, 2022],
                    id='my-range-slider',
                    marks={i: f'{i}' for i in range(2008, 2023)}, className='col-span-2', persistence='years')

], className='dark:text-white flex flex-col gap-5 md:grid md:grid-cols-5 md:gap-4'),
    html.Div(children=[
        html.H1('dfkjdlsjflk', className='dark:text-white font-extrabold text-3xl'),
